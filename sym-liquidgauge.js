...
(function (PV) {
	...
	//Most lines commented out represent d3 version 3 lines that were altered to have symbol work with d3 version 4
...
/////////////////////////////////////////////////////////////////////////////////
		//In most recent version of d3, this.textContext is not available
        ...
        function GaugeUpdater() {
            this.update = function (value) {
				...
				text1.transition()
					.duration(config.waveRiseTime)
					.tween("text", function() {
					  const i = d3.interpolateNumber(text1InterpolatorValue, parseFloat(value).toFixed(2));
					  return (t) => {
						text1InterpolatorValue = textRounder(i(t));
						// Set the gauge's text with the new value and append the % sign
						// to the end
				...
				text2.transition()
					.duration(config.waveRiseTime)
					.tween("text", function() { 
					  const i = d3.interpolateNumber(text2InterpolatorValue, parseFloat(value).toFixed(2));
					  return (t) => {
						text2InterpolatorValue = textRounder(i(t));
						// Set the gauge's text with the new value and append the % sign
						// to the end                
